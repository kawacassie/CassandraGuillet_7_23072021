    ...
    <div id="navbarContent" class="m-0 p-0 justify-content-end align-self-center">
        <div class="nav-item dropdown m-0 p-0">
            ...
            <div class="dropdown-menu dropdown-menu-right " aria-labelledby="my_account">
                <div class="d-flex"><i class="fas fa-sign-in-alt pl-6"></i><router-link to="/login" class="dropdown-item pl-2">Connexion</router-link></div>
                <div class="d-flex"><i class="fas fa-user-plus pl-6"></i><router-link to="/signup" class="dropdown-item pl-2">Inscription</router-link></div>
            </div>
        </div>            
    </div>
</template>
